...
export LOCAL_BIN=/home/bournas/.local/bin
#export MASON_PATH=$HOME/.local/share/modern-neovim/mason

# export INTELLIJ_HOME=/home/bournas/tools/idea-IU-253.30387.90

export PATH=$M2_HOME/bin:$PATH:/home/bournas/.local/bin:/home/bournas/programming/nokia/ee-environment/boxes/common-box:$ALTIPLANO_TOOLS_DIR/bin:$ALTIPLANO_TOOLS_DIR/scripts:$ALTIPLANO_SCRIPTS_DIR/bin:$ALTIPLANO_SCRIPTS_DIR/scripts/0-dev-altiplano-installation:$ALTIPLANO_SCRIPTS_DIR/scripts/3-build-container:${INTELLIJ_HOME}/bin:${DEVCONTAINTER_HOME}:${MASON_PATH}/bin:${LOCAL_BIN}
